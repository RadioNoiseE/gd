...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Iosevka Fixed Curly Slab"
                               :size 12.5
                               :weight normal
                               :width normal)
   ...
   dotspacemacs-scroll-bar-while-scrolling 2
...
;;                          (font-spec :family "Noto Serif CJK TC" :size 17)))
  (set-default 'preview-scale-function 0.74)
